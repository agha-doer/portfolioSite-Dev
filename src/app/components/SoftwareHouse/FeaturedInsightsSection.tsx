...
const BackgroundAnimation = () => {
  ...
  const [cubes, setCubes] = useState<Array<{id: number; delay: number; duration: number; size: number; color: string}>>([]);
  const [spheres, setSpheres] = useState<Array<{id: number; delay: number; duration: number; size: number; color: string}>>([]);
